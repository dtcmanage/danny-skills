...
- 1.2.0 (2026-07-05): Intake accepts design-final-<slug>.md (legacy still works); roadmap-view.html on request only via -EmitRoadmapView; view verification via shared verify-html-artifact.ps1 -RequireMermaid; changelog relocated to CHANGELOG.md.
